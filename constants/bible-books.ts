...
export const BIBLE_BOOKS: BibleBook[] = [
  ...
  { name: 'John',          abbr: 'Joh',  chapters: 21, testament: 'NT' },
  ...
  { name: '1 John',        abbr: '1Jo',  chapters: 5,  testament: 'NT' },
  { name: '2 John',        abbr: '2Jo',  chapters: 1,  testament: 'NT' },
  { name: '3 John',        abbr: '3Jo',  chapters: 1,  testament: 'NT' },
